...
public class MadrasatiMicroserviceApp {

    private static final Logger log = LoggerFactory.getLogger(MadrasatiMicroserviceApp.class);

    private final Environment env;

    public MadrasatiMicroserviceApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MadrasatiMicroservice.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MadrasatiMicroserviceApp.class);
